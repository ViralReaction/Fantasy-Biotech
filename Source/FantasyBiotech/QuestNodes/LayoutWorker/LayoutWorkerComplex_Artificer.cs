...
{
	public class LayoutWorkerComplex_Artificer : LayoutWorkerComplex
	{
		...
		private readonly List<CellRect> tmpAllRoomRects = [];

		public LayoutWorkerComplex_Artificer(LayoutDef def) : base(def)
		{
		}

		public override Faction GetFixedHostileFactionForThreats()
		{
			return MechUtility.ConstructFaction();
		}

		public override void PreSpawnThreats(List<LayoutRoom> rooms, Map map, List<Thing> allSpawnedThings)
		{
