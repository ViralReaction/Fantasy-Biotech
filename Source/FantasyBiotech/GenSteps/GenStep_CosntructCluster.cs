...
namespace FantasyBiotech
{
    ...
    public class GenStep_ConstructCluster : GenStep
    {
        ...
        {
            MechClusterSketch sketch = ConstructClusterGenerator.GenerateClusterSketch(parms.sitePart.parms.threatPoints, map, startDormant: true, forceNoConditionCauser);
