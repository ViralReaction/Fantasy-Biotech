...
{
    public class Verb_ConstructFlame : Verb
    {
        ...
        public override bool TryCastShot()
        {
            ...
            GenExplosion.DoExplosion(affectedAngle: new FloatRange(num - 13f, num + 13f), center: position, map: caster.MapHeld, radius: verbProps.range, damType: DamageDefOf.Flame, instigator: caster, damAmount: verbProps.meleeDamageBaseAmount, armorPenetration: verbProps.meleeArmorPenetrationBase, explosionSound: null, weapon: null, projectile: null, intendedTarget: null, postExplosionSpawnThingDef: ThingDefOf.Filth_FlammableBile, postExplosionSpawnChance: 1f, postExplosionSpawnThingCount: 1, postExplosionGasType: null, applyDamageToExplosionCellsNeighbors: false, preExplosionSpawnThingDef: null, preExplosionSpawnChance: 0f, preExplosionSpawnThingCount: 1, chanceToStartFire: 1f, damageFalloff: false, direction: null, ignoredThings: null, doVisualEffects: false, propagationSpeed: 0.6f, excludeRadius: 0f, doSoundEffects: false);
            AddEffecterToMaintain(EffecterDefOf.Fire_SpewShort.Spawn(caster.Position, currentTarget.Cell, caster.Map), caster.Position, currentTarget.Cell, verbProps.ticksBetweenBurstShots , caster.Map);
