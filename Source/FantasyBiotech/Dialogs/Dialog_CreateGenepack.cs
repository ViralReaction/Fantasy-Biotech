...
public class Dialog_CreateGenepack : GeneCreationDialogBase
{
	private Building_GraftForge geneAssembler;
	...
	public override string Header => "AssembleGenes".Translate();

	public override string AcceptButtonLabel => "StartCombining".Translate();
	...
	public Dialog_CreateGenepack(Building_GraftForge geneAssembler)
	{
