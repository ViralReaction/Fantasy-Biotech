...
{
    [HarmonyPatch(typeof(SymbolResolver_Interior_AncientTemple), nameof(SymbolResolver_Interior_AncientTemple.Resolve))]
    public static class SymbolResolver_Interior_AncientTemple_Resolve
    {
